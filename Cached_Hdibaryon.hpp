...
struct Hdibaryon : POD::LambdaPair {
    ...
    Hdibaryon(const POD::LambdaPair& hdib, const POD::Extended::PreFoundLambda& l1, const POD::Extended::PreFoundLambda& l2,
        ...
        : POD::LambdaPair(hdib),
          ...
          l2_pca_wrt_pv{Common::Math::FastPCA_LineVertex(lv_l2.Vect(), dv_l2, pv)},
    ...
    // (anti)lambda 1 //
    [[nodiscard]] double L1_Pz() const { return lv_l1.Pz(); }
    [[nodiscard]] double L1_Pt() const { return lv_l1.Pt(); }
    [[nodiscard]] double L1_P() const { return lv_l1.P(); }
    ...
    [[nodiscard]] double L1_DecayLength() const { return (l1_pca_wrt_dv - dv_l1).R(); }
    ...
    [[nodiscard]] double L1_DCA_wrt_PV() const { return (l1_pca_wrt_pv - pv).R(); }
    [[nodiscard]] double L1_Chi2NDF() const { return L1->Chi2NDF; }
    ...
    // -- related to (anti)lambda 1
    [[nodiscard]] double Pr1_DCA_wrt_L1() const { return ((IsAntiChannel ? l1_neg_pca_wrt_l1 : l1_pos_pca_wrt_l1) - dv_l1).R(); }
    // pion (minus/plus) 1 //
    ...
    // -- related to (anti)lambda 1
    [[nodiscard]] double Pi1_DCA_wrt_L1() const { return ((IsAntiChannel ? l1_pos_pca_wrt_l1 : l1_neg_pca_wrt_l1) - dv_l1).R(); }
    // (anti)lambda 2 //
    [[nodiscard]] double L2_Pz() const { return lv_l2.Pz(); }
    [[nodiscard]] double L2_Pt() const { return lv_l2.Pt(); }
    [[nodiscard]] double L2_P() const { return lv_l2.P(); }
    ...
    [[nodiscard]] double L2_DecayLength() const { return (l2_pca_wrt_dv - dv_l2).R(); }
    ...
    [[nodiscard]] double L2_DCA_wrt_PV() const { return (l2_pca_wrt_pv - pv).R(); }
    [[nodiscard]] double L2_Chi2NDF() const { return L2->Chi2NDF; }
    // -- related to (anti)h-dibaryon
    ...
    // -- related to (anti)lambda 2
    [[nodiscard]] double Pr2_DCA_wrt_L2() const { return ((IsAntiChannel ? l2_neg_pca_wrt_l2 : l2_pos_pca_wrt_l2) - dv_l2).R(); }
    // pion (minus/plus) 2 //
    ...
    // -- related to (anti)lambda 2
    [[nodiscard]] double Pi2_DCA_wrt_L2() const { return ((IsAntiChannel ? l2_pos_pca_wrt_l2 : l2_neg_pca_wrt_l2) - dv_l2).R(); }
    // correlations //
